...
export default class Controller extends Phaser.Scene {
    ...
    create()
    {
        ...
        if (mobileAndTabletCheck()) 
        {
            ...
            this.joystickBase1 = this.add.circle(150, 450, 150, 0x000000).setAlpha(0.5);
            this.joystickThumb1 = this.add.circle(150, 450, 100, 0xcccccc).setAlpha(0.5);
            ...
            this.attackButton = this.add.circle(750, 800, 80, 0x000000).setAlpha(0.5)
                .setInteractive()
                .on('pointerdown', ()=> this.attack = true)
              //  .on('pointerup', ()=> this.attack = false)
                //.on('pointerout', ()=> this.attack = false);
